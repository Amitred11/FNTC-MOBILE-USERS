...
const API_URL = 'https://API_NAME.onrender.com/api'; // Change this IP for your setup
const Config_INTERNAL_API_KEY = 'Config_INTERNAL_API_KEY';
const CHATBOT_API_ENDPOINT = 'https://API_NAME.onrender.com';
const apiConfig = {
  API_URL,
