    ...
    return (
      <View style={{ flex: 1, backgroundColor: theme.background }}>
        ...
        <FlatList
          ...
          ListHeaderComponent={messages.length <= 1 ? <SuggestedPrompts onPromptSelect={(q) => sendChatMessage(q)} /> : null}
...
const getStyles = (theme) => StyleSheet.create({
    ...
    avatarShell: { width: 34, height: 34, borderRadius: 17, backgroundColor: theme.border, overflow: 'hidden', marginBottom: 3 },
    ...
    typingBubble: { width: 80, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', paddingVertical: 14 },
    ...
    sendButtonInactive: { backgroundColor: theme.disabled },
    
    placeholderContent: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20, backgroundColor: theme.background },
    placeholderText: { fontSize: 16, color: theme.textSecondary, textAlign: 'center', lineHeight: 22, marginTop: 16 },
    ...
    bannerOffline: { backgroundColor: theme.danger },
    bannerReconnecting: { backgroundColor: theme.warning },
    bannerText: {
